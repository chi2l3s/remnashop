...
### Telegram Bot UI
- [ ] Добавить кнопку "Докупить устройства" в меню подписки
- [ ] Диалог выбора количества устройств
- [ ] Интеграция с платежными шлюзами
- [ ] Уведомления об успешной покупке
- [ ] Отображение истории покупок

### Admin Panel
- [ ] UI для настройки цен за устройство
- [ ] Просмотр истории покупок устройств
- [ ] Статистика по продажам устройств

### API Endpoints (если нужно для web)
- [ ] POST /api/subscriptions/{id}/purchase-devices
- [ ] GET /api/subscriptions/{id}/device-purchases
- [ ] GET /api/settings/device-purchase
